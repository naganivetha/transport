...
} composition, $x$, extracted from SHE measurements. The solid line is a 
...
\num{0.68}$. %as shown in Fig. \ref{fig:ru_conc}(a). 
...
effect (SHE) measurements. %as shown in Fig. \ref{fig:she}(a). 
